...
Animated.addWhitelistedNativeProps({ text: true });//This is required  to animate the texts
...
const ChatDetailsPage = () => {
  ...
  const animatedDateText = useAnimatedProps(() => {// we use this as the value doesn't syncs in charts.
